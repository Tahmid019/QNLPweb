...
<section id="importantTimes" class="relative mx-auto mt-28 max-w-7xl px-6 text-center md:px-8">
  ...
  <a href="https://openreview.net/group?id=aclweb.org/AACL-IJCNLP/2025/Workshop/QuantumNLP#tab-your-consoles">
    <p class="text-center  mt-10 text-[0.5rem] md:text-[0.8rem] lg:text-[1rem] xl:text-[1.2rem] pointer-events-none whitespace-pre-wrap bg-gradient-to-b from-[var(--black-0)] to-[var(--black-4)] bg-clip-text font-medium font-poppins leading-none text-transparent">
    Open Review | Please Login First & then click on the Link {"[ Click Here ] "}
  </p>
  </a>
