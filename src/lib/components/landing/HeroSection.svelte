...
<section id="hero" class="relative z-30 mx-auto mt-14 md:mt-24 lg:mt-32 max-w-7xl px-6 text-center md:px-8">
	<div class="hero-container relative flex flex-col-reverse lg:flex-row xl:-translate-x-16">
		<div class="left-container relative lg:w-[70%]">
			<h1
				class="-translate-y-4 animate-fade-in text-balance font-poppins lg:text-right bg-gradient-to-br from-black from-30% to-black/40 bg-clip-text pt-6 text-5xl font-semibold leading-none tracking-tighter text-transparent opacity-0 [--animation-delay:200ms] dark:from-white dark:to-white/40 sm:text-6xl md:text-7xl lg:text-8xl"
			>
				QuantumNLP
			</h1>
			<h2
				class="-translate-y-4 animate-fade-in text-balance font-poppins lg:text-right bg-gradient-to-br from-black from-30% to-black/40 bg-clip-text pb-6 pt-2 text-2xl font-medium leading-none tracking-tighter text-transparent opacity-0 [--animation-delay:200ms] dark:from-white dark:to-white/40 sm:text-3xl md:text-4xl lg:text-5xl"
			>
